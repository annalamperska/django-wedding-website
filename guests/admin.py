...
class PartyAdmin(admin.ModelAdmin):
    list_display = ('name', 'category', 'invitation_opened', 'is_attending', 'transportationNeeded', 'friSatAccommodation', 'satSunAccommodation', 'phoneNumber', 'emailAddress', 'comments')
